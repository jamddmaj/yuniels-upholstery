...
function renderGallery(images) {
  galleryEl.innerHTML = "";
  if (!images.length) {
    galleryEl.innerHTML = '<div style="color:#b6eaff; padding: 22px;">No hay imÃ¡genes para este modelo.</div>';
    return;
  }
...
// Cargar por defecto
buscar("northtech");// Aquí irá el JavaScript que controla menú, galería, búsqueda, etc.
